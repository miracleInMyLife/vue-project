<template>
  <div class="shop-header">
    <nav class="shop-nav"
      ...
      <a class="back">
        <i class="iconfont icon-arrowleft" @click="$router.replace('/msite')"/>
      </a>
    </nav>

    <div class="shop-content" @click="isShowBrand = !isShowBrand">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowSale = !isShowSale">
      <div class="discounts-left">
        <div class="activity" :class="`activity-${info.supports[0].type}`">
          <span class="content-tag">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-if="isShowBrand">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer">
            <span class="iconfont icon-guanbi" @click="isShowBrand = false"></span>
          </div>
        </div>
        <div class="brief-modal-cover" @click="isShowBrand = false"></div>
      </div>
    </transition>

    <transition name="fade">
      <div class="activity-sheet" v-show="isShowSale">
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">
          优惠活动</h2>
          <ul class="list">
            <li class="activity-item" v-for="(support,index) in info.supports" :key="index" :class="`activity-${support.type}`">
              <span class="content-tag">
          ...
          <div class="activity-sheet-close">
            <span class="iconfont icon-guanbi" @click="isShowSale= false"></span>
          </div>
        </div>
