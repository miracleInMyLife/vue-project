  ...
  <div class="shop-info"  ref="info">
    <div class="info-content">
      <section class="section">
        ...
        <div class="delivery">
          <div>
            ...
            <span>由商家配送提供配送，约{{info.deliveryTime}}分钟送达，距离{{info.diatance}}</span>
          </div>
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item activity-green"  v-for="(support,index) in info.supports" :key="index" :class="`activity-${support.type}`">
